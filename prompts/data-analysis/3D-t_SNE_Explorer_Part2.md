# Prompt: 3D t-SNE Explorer (Part 2)
version: v1
status: experimental
model: gemini
...
## Prompt 1
Please re-label all the notes and clusters (including the legend) to align with fictitious organisational communication patterns. For example: Boss (Network Leader), Lieutenant (Second-in-command), Enforcer (Operative), Money Mule (Financial Agent), Broker (Facilitator), Outlier (Unknow Actor). This will support analysis of financial transactions, and other data to identify and disrupt criminal networks. 
